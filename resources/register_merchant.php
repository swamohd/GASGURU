...
// check registrationn
$sql3="SELECT * FROM tbl_merchants WHERE email='$email' OR phone='$phone'";
...
// insert into db
$insert=mysqli_query($con,"INSERT INTO tbl_merchants (first_name,last_name,email,phone,password,date_registered)
